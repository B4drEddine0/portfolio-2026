...
function initThreeBackground() {
  ...
  const pointLight1 = new THREE.PointLight(0xfbbf24, 1.2, 25)
  ...
  function animate() {
    ...
    for (let i = 0; i <= 30; i++) {
      const t = i / 30
      const swayAmount = Math.sin(t * Math.PI) * Math.sin(time * 0.4) * 0.15
      const pos = new THREE.Vector3(
        threadStart.x + (threadEnd.x - threadStart.x) * t + swayAmount,
        threadStart.y + (threadEnd.y - threadStart.y) * t,
        threadStart.z + (threadEnd.z - threadStart.z) * t
      )
      currentThreadPoints.push(pos)
    }
    silkThread.geometry.setFromPoints(currentThreadPoints)
  ...
  app.innerHTML = `
    ...
    <div class="portfolio-wrapper">
      ...
      <main class="main-container">
        <nav class="tab-nav">
          <button class="tab-btn active" data-tab="about">À propos</button>
          <button class="tab-btn" data-tab="resume">CV</button>
